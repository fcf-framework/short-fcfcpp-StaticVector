...
void staticVectorExceptionTest(){
  ...
  {
    typedef fcf::StaticVector<FcfTest::StaticVectorExceptionTest::Item, 2, 0, 2, 2, 0, 0> static_vector_type;
    FcfTest::StaticVectorExceptionTest::g_exceptValue = 2;
    FcfTest::StaticVectorExceptionTest::g_initCounter = 0;
    try {
  ...
  {
    typedef fcf::StaticVector<FcfTest::StaticVectorExceptionTest::Item, 8, 0, 2, 1, 0, 0> static_vector_type;
    FcfTest::StaticVectorExceptionTest::g_exceptValue = 0;
    FcfTest::StaticVectorExceptionTest::g_initCounter = 0;
    ...
    v2[2].value = 30;
    v2[3].value = 40;
    FcfTest::StaticVectorExceptionTest::g_exceptValue = 3;
    FcfTest::StaticVectorExceptionTest::g_initCounter = 0;
    try {
      v2 = v1;
    } catch(std::runtime_error&){
  ...
  {
    typedef fcf::StaticVector<FcfTest::StaticVectorExceptionTest::Item, 2, 0, 2, 1, 0, 0> static_vector_type;
    FcfTest::StaticVectorExceptionTest::g_exceptValue = 0;
    FcfTest::StaticVectorExceptionTest::g_initCounter = 0;
    static_vector_type v1(4);
    v1[0].value = 1;
...

  {
    ...
    v1[2].value = 3;
    v1[3].value = 4;
    FcfTest::StaticVectorExceptionTest::g_exceptValue = 4;
    FcfTest::StaticVectorExceptionTest::g_initCounter = 0;
    try {
      v1.push_back({5, true});
    } catch(std::runtime_error&){
  ...
  }
  {
    ...
    v1[2].value = 3;
    v1[3].value = 4;
    FcfTest::StaticVectorExceptionTest::g_exceptValue = 5;
    FcfTest::StaticVectorExceptionTest::g_initCounter = 0;
    try {
      v1.resize(10);
    } catch(std::runtime_error&){
